        ...
        <ul class="list-unstyled components">
            ...
            <?php if (Permissions::getInstaince()->hasPermision('university_index') == true
                ...
                <li id="accordionExample">
                    <a class="nav-link collapsed" href="#" data-target="#collapseExample1" data-toggle="collapse"
                    ...
                    <ul class="collapse  list-unstyled" id="collapseExample1" class="collapse"
                        ...
                        <?php if (Permissions::getInstaince()->hasPermision('university_index') == true) { ?>
                            <li>
                                <a href="/admin/universities/index"><i class="ion ion-university  "></i> <label
                                            class="text"> الجامعات</label>
                                </a>
                            </li>
                        <?php } ?>
                        <?php if (Permissions::getInstaince()->hasPermision('teacher_index') == true) { ?>
                            ...
                            <li>
                                <a href="/admin/teachers/index"><i class="fa fa-chalkboard-teacher "></i> <label
                                            class="text"> المدرسين</label>
                                </a>
                            </li>
                        <?php } ?>
                    </ul>
            ...
            <?php if (Permissions::getInstaince()->hasPermision('teacher_index') == true
                ...
                <li id="accordionExampleOne">
                    <a href="#" data-target="#collapseExample" data-toggle="collapse" aria-expanded="true"
                    ...
                    <ul class="collapse  list-unstyled" id="collapseExample" aria-labelledby="headingOne"
                        data-parent="#accordionExampleOne">
                        <?php if (Permissions::getInstaince()->hasPermision('role_index') == true) { ?>
                            <li>
                                <a href="/admin/role/index"><i class="fa fa-users-cog "></i> <label class="text">
                                        الادوار</label>
                        ...
                        <?php if (Permissions::getInstaince()->hasPermision('permission_index') == true) { ?>
                            ...
                            <li>
                                <a href="/admin/permision/index"><i class="fa fa-cogs "></i> <label class="text">
                                        الصلاحيات</label></a>
                            </li>
                        <?php } ?>
                    </ul>
                            ...
                            <ul class="dropdown-menu animated bounceIn ">
                                ...
                                <li class="header bg-light ">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-left text-danger"><a href="" style="background: none">محو
                                                الكل</a></div>
                                ...
                                <li class="user-notification" id="notification-users">
                                    <label class="dropdown-item" id="notf"> <i class="fa fa-users text-info"></i>
                                        Curabitur id eros quis nunc suscipit </label>
                                    <label class="dropdown-item" id="notf1"> <i
                                                class="ion ion-android-warning text-warning"></i> Duis malesuada justo
                                    </label>
                                    <label class="dropdown-item" id="notf2"><i
                                                class="fa fa-shopping-cart text-success"></i> In gravida mauris et nisi</label>
                                    <label class="dropdown-item" id="notf3"> <i class="fa fa-user text-danger"></i>
                                        Praesent eu lacus in libero d</label>
                                    <label class="dropdown-item" id="notf4"> <i class="fa fa-user text-primary"></i>
                                        Nunc fringilla lorem </label>
                                    <label class="dropdown-item" id="notf5"> <i class="fa fa-user text-primary"></i>
                                        Nunc fringilla lorem </label>
                                    <label class="dropdown-item" id="notf6 "> <i class="fa fa-user text-primary"></i>
                                        Nunc fringilla lorem </label>
                        ...
                        <li class="nav-item dropdown  ">
                            <a href="#" class="nav-link" data-toggle="dropdown">
                                ...
                                <img src=" <?php echo(Session::get('user')['user_image']); ?>"
                                     class="user-image rounded-circle" alt="User Image" width="30px" height="26px">
                            </a>
                            <ul class="dropdown-menu animated flipInX">
                                ...
                                <li class="user-header bg-img" id="imgae" style="" data-overlay="5">
                                    <div class="flexbox align-self-center">
                                        <img src="<?php echo(Session::get('user')['user_image']); ?>"
                                             class="float-left rounded-circle" alt="User Image" width="30px"
                                             height="30px">
                                ...
                                <!-- Menu Body -->
                                <li class="user-body">
                                    <a class="dropdown-item" href="/admin/profile/index"><i class="ion ion-person"></i>
                                        تعديل الملف الشخصي</a>
                                    <a class="dropdown-item" href="javascript:void(0)"><i
                                                class="ion ion-email-unread"></i> الإيميل</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="javascript:void(0)"><i class="ion ion-settings"></i>إعدادات
                                        الحساب </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="/admin/logout"><i class="ion-log-out"></i> تسجيل
                                        الخروج</a>
                                    <div class="dropdown-divider"></div>
