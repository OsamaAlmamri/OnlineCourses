            ...
            <li class="nav-item dropdown ">
                <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
                    ...
                    <img src="<?php echo(Session::get('user')['user_image']); ?>" class="rounded-circle"
                         width="25"> <?php echo(Session::get('user')['user_name']) ?>
                </a>

                <div class="dropdown-menu">
                    <a class="dropdown-item" href="#"><i class="ion ion-edit"></i> Edit Profile</a>
                    <a class="dropdown-item" href="/admin/logout"><i class="ion ion-log-out"></i> Logout</a>
...
<div class="sidebar" id="mySidenav">
    <div class="image_back">
        <img src="<?php echo(Session::get('user')['user_image']) ?>" class="rounded-circle" alt="Cinque Terre"
             width="30">
    </div>
    <div class="link">
