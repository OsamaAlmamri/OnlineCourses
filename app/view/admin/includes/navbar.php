    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown " >
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="#"><i class="ion ion-log-out"></i> Logout</a>
        ...
        <div class="panel-group">
            <div class="panel panel-default">
                <div class="panel-heading">
                        ...
                        <a data-toggle="collapse" href="#collapse1"><i class="fa fa-users-cog iconi"></i> <label class="hrefLabel">Accounts<i class="fa fa-angle-down " ></i></label></a>
                ...
                <div id="collapse1" class="panel-collapse collapse">
                    ...
                    <div class="panel-footer">
                        <a href="/admin/universities/index"><i class="ion ion-university icon"></i> <label class="hrefLabel">Universities</label></a>
                        <a href="/admin/teachers/index"><i class="fa fa-chalkboard-teacher icon"></i> <label class="hrefLabel">Teachers</label></a>
                        </div>
                </div>
            </div>
        </div>
        <div class="panel-group">
            <div class="panel panel-default">
                <div class="panel-heading">
                        ...
                        <a data-toggle="collapse" href="#collapse2"><i class="fa fa-users-cog iconi"></i> <label class="hrefLabel">Manages<i class="fa fa-angle-down " ></i></label></a>
